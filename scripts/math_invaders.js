...
function debut_jeu(){
	if (!jeu_en_cours) {
		...
		espace_operation.style.visibility = "visible";
		input_j.style.visibility = "visible";
		op_g.textContent = assigne_operation_1()
	};
};
...
function fin_jeu() {
	if (jeu_en_cours) {
		...
		espace_operation.style.visibility = "hidden";
		input_j.style.visibility = "hidden";
	};
};
